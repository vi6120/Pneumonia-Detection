...
\DeclareAcronym{ALPDR}
{
    short = ALPDR\index{ALPDR},
    long  = Automatic License Plate Detection and Recognition  
    \index{Automatic License Plate Detection and Recognition \Siehe{ALPDR}},
}
