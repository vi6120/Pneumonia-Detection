...
\DeclareAcronym{SVM}{
	short = SVM\index{SVM}, 
	long  = Support Vector Machines\index{Support Vector Machines!\Siehe SVM},
}
...
\DeclareAcronym{tflm}{
    short = TFLM\index{TFLM} ,
    long  = TensorFlow Lite Microcontrollers\index{TensorFlow Lite Microcontrollers!\Siehe TFLM},
}    
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% U
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
